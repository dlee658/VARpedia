...
public class VideoCreation {
	...
	public void createVideo(String term,int numOfImages ,String name) {
		...
		try {	
			...
			String cmd = "cat Image\\*.jpg | ffmpeg -f image2pipe -framerate " + numOfImages + "/`soxi -D " + audio + "` -i - -i "+ audio + " -c:v libx264 -pix_fmt yuv420p -vf \"scale=640:480:force_original_aspect_ratio=decrease,"
